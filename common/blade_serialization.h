 ...
 *fun      : used by HA
 */
#ifndef BLADESTORE_COMMON_SERIALIZATION_H
#define BLADESTORE_COMMON_SERIALIZATION_H
...
const uint64_t BLADE_MAX_V1B = (__UINT64_C(1) << 7) - 1;
const uint64_t BLADE_MAX_V2B = (__UINT64_C(1) << 14) - 1;
const uint64_t BLADE_MAX_V3B = (__UINT64_C(1) << 21) - 1;
const uint64_t BLADE_MAX_V4B = (__UINT64_C(1) << 28) - 1;
const uint64_t BLADE_MAX_V5B = (__UINT64_C(1) << 35) - 1;
const uint64_t BLADE_MAX_V6B = (__UINT64_C(1) << 42) - 1;
const uint64_t BLADE_MAX_V7B = (__UINT64_C(1) << 49) - 1;
const uint64_t BLADE_MAX_V8B = (__UINT64_C(1) << 56) - 1;
const uint64_t BLADE_MAX_V9B = (__UINT64_C(1) << 63) - 1;


const uint64_t BLADE_MAX_1B = (__UINT64_C(1) << 8) - 1;
const uint64_t BLADE_MAX_2B = (__UINT64_C(1) << 16) - 1;
const uint64_t BLADE_MAX_3B = (__UINT64_C(1) << 24) - 1;
const uint64_t BLADE_MAX_4B = (__UINT64_C(1) << 32) - 1;
const uint64_t BLADE_MAX_5B = (__UINT64_C(1) << 40) - 1;
const uint64_t BLADE_MAX_6B = (__UINT64_C(1) << 48) - 1;
const uint64_t BLADE_MAX_7B = (__UINT64_C(1) << 56) - 1;
const uint64_t BLADE_MAX_8B = UINT64_MAX;



const uint64_t BLADE_MAX_INT_1B = (__UINT64_C(23));
const uint64_t BLADE_MAX_INT_2B = (__UINT64_C(1) << 8) - 1;
const uint64_t BLADE_MAX_INT_3B = (__UINT64_C(1) << 16) - 1;
const uint64_t BLADE_MAX_INT_4B = (__UINT64_C(1) << 24) - 1;
const uint64_t BLADE_MAX_INT_5B = (__UINT64_C(1) << 32) - 1;
const uint64_t BLADE_MAX_INT_7B = (__UINT64_C(1) << 48) - 1;
const uint64_t BLADE_MAX_INT_9B = UINT64_MAX;
      
      
const int64_t BLADE_MAX_1B_STR_LEN = (__INT64_C(55));
const int64_t BLADE_MAX_2B_STR_LEN = (__INT64_C(1) << 8) - 1;
const int64_t BLADE_MAX_3B_STR_LEN = (__INT64_C(1) << 16) - 1;
const int64_t BLADE_MAX_4B_STR_LEN = (__INT64_C(1) << 24) - 1;
const int64_t BLADE_MAX_5B_STR_LEN = (__INT64_C(1) << 32) - 1;

const int8_t BLADE_INT_TYPE_BIT_POS = 7;
const int8_t BLADE_INT_OPERATION_BIT_POS = 6;
const int8_t BLADE_INT_SIGN_BIT_POS = 5;
const int8_t BLADE_DATETIME_OPERATION_BIT = 3;
const int8_t BLADE_DATETIME_SIGN_BIT = 2;
const int8_t BLADE_FLOAT_OPERATION_BIT_POS = 0;

const int8_t BLADE_INT_VALUE_MASK = 0x1f;
const int8_t BLADE_VARCHAR_LEN_MASK = 0x3f;
const int8_t BLADE_DATETIME_LEN_MASK =  0x3;


const int8_t BLADE_VARCHAR_TYPE = (0x1 << 7);
const int8_t BLADE_SEQ_TYPE = 0xc0;
const int8_t BLADE_DATETIME_TYPE = 0xd0;
const int8_t BLADE_PRECISE_DATETIME_TYPE = 0xe0;
const int8_t BLADE_MODIFYTIME_TYPE = 0xf0;
const int8_t BLADE_CREATETIME_TYPE = 0xf4;
const int8_t BLADE_FLOAT_TYPE = 0xf8;
const int8_t BLADE_DOUBLE_TYPE = 0xfa;
const int8_t BLADE_NULL_TYPE =  0xfc;
const int8_t BLADE_EXTEND_TYPE = 0xfe;
...
{
	int ret =((NULL != buf) && ((buf_len - pos) >= static_cast<int64_t>(sizeof(val)))) ? BLADE_SUCCESS : BLADE_ERROR;
...
{
	int ret = (NULL != buf && data_len - pos >= 1) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
		*val = *(buf + pos++);
	}
...
{
	int ret = (NULL != buf && data_len - pos  >= 2) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
...
inline int decode_i32(const char * buf,const int64_t data_len,int64_t& pos,int32_t* val)
{
	...
	int ret = (NULL != buf && data_len - pos  >= 4) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
...
{
	int ret = (NULL != buf && data_len - pos  >= 8) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
...
inline int64_t encoded_length_vi64(int64_t val)
{
	...
	if (__v <= BLADE_MAX_V1B)
		need_bytes = 1;
	else if (__v <= BLADE_MAX_V2B)
		need_bytes = 2;
	else if (__v <= BLADE_MAX_V3B)
		need_bytes = 3;
	else if (__v <= BLADE_MAX_V4B)
		need_bytes = 4;
	else if (__v <= BLADE_MAX_V5B)
		need_bytes = 5;
	else if (__v <= BLADE_MAX_V6B)
		need_bytes = 6;
	else if (__v <= BLADE_MAX_V7B)
		need_bytes = 7;
	else if (__v <= BLADE_MAX_V8B)
		need_bytes = 8;
	else if (__v <= BLADE_MAX_V9B)
		need_bytes = 9;
	else 
		need_bytes = 10;
	return need_bytes;
...
{
	uint64_t __v = static_cast<uint64_t>(val); 
	int ret =((NULL != buf) && ((buf_len - pos) >= encoded_length_vi64(__v))) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
		while (__v > BLADE_MAX_V1B)
		{
...
inline int encode_vi32(char *buf,const int64_t buf_len,int64_t& pos,int32_t val)
{
	...
	int ret = ((NULL != buf) && ((buf_len - pos) >= encoded_length_vi32(val))) ? BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
		while (__v > BLADE_MAX_V1B)
		{
...
{
	int ret = ((NULL != buf) && (len >= 0) && ((buf_len - pos) >= static_cast<int32_t>(encoded_length_vstr(len)))) ?  BLADE_SUCCESS : BLADE_ERROR;
	if (BLADE_SUCCESS == ret)
	{
		/**
		...
		if (BLADE_SUCCESS == ret && len > 0 && NULL != vbuf)
		{
...
inline const char *decode_vstr(const char *buf,const int64_t data_len,int64_t& pos,int64_t *lenp)
{
	...
	else if ( decode_vi64(buf,data_len,tmp_pos,&tmp_len) != BLADE_SUCCESS)
	{
		*lenp = -1;
	}
	else if (tmp_len >= 0)
...
inline const char *decode_vstr(const char *buf,const int64_t data_len,int64_t& pos, char *dest,int64_t buf_len,int64_t *lenp)
{
	const char *str = 0;
	int64_t tmp_len = 0;
	int64_t tmp_pos = pos;
 ...
 * 
 * @return on success,BLADE_SUCCESS is returned, on error,BLADE_ERROR is returned.
 */
...
{
	return encode_i8(buf,buf_len,pos,BLADE_NULL_TYPE);
}
 ...
 * 
 * @return  on success, BLADE_SUCCESS is returned
 */
inline int __encode_uint_with_given_length(char *buf, const int64_t buf_len, int64_t& pos, const uint64_t val, int64_t val_len)
{
	int ret = BLADE_SUCCESS;
...
inline int __decode_uint_with_given_length(const char *buf,const int64_t data_len, int64_t& pos, uint64_t& val,int64_t val_len)
{
	int ret = BLADE_SUCCESS;
	...
	else
	{
		...
		for(int64_t n=0;n < val_len; ++n)
		{
			if ( BLADE_SUCCESS != (ret = decode_i8(buf,data_len,tmp_pos,&tmp)))
			{
				ret = BLADE_ERROR;
				break;
			}
...
inline int64_t encoded_length_int(int64_t val)
{
	...
	int64_t len = 0;
	if (__v <= BLADE_MAX_INT_1B)
		len = 1;
	else if(__v <= BLADE_MAX_INT_2B)
		len = 2;
	else if(__v <= BLADE_MAX_INT_3B)
		len = 3;
	else if(__v <= BLADE_MAX_INT_4B)
		len = 4;
	else if(__v <= BLADE_MAX_INT_5B)
		len = 5;
	else if(__v <= BLADE_MAX_INT_7B)
		len = 7;
	else /*if(__v < BLADE_MAX_INT_9B)*/
		len = 9;
	return len;
}
...
inline int encode_int(char *buf, const int64_t buf_len, int64_t& pos, int64_t val, bool is_add = false)
{
	...
	else
	{
		...
		if (val < 0)
		{
			set_bit(first_byte,BLADE_INT_SIGN_BIT_POS);
		}

		if (is_add)
		{
			set_bit(first_byte,BLADE_INT_OPERATION_BIT_POS);
		}
		uint64_t __v = safe_int64_abs(val);
		...
		else
		{
			...
			first_byte |= ((tmp_len - 1) + BLADE_MAX_INT_1B);
		}

		if ( BLADE_SUCCESS != (ret = encode_i8(buf,buf_len,pos,first_byte)))
		{
			ret = BLADE_ERROR;
		}
		else
...
inline int decode_int(const char *buf,const int64_t data_len,int8_t first_byte,int64_t& pos,int64_t& val,bool& is_add)
{
	...
	{
		bool is_neg = test_bit(first_byte,BLADE_INT_SIGN_BIT_POS);
		is_add = test_bit(first_byte,BLADE_INT_OPERATION_BIT_POS);
		int8_t len_or_value = first_byte & BLADE_INT_VALUE_MASK;
		int64_t __v = 0;

		if (len_or_value <= static_cast<int8_t>(BLADE_MAX_INT_1B))
		{
		...
		{
			int64_t len = len_or_value - BLADE_MAX_INT_1B;
			if ( 5 == len || 7 == len)
			{
				len += 1;
			}
...
inline int64_t encoded_length_str_len(int64_t len)
{
	...
	{
		if (len <= BLADE_MAX_1B_STR_LEN)
			ret = 1;
		else if(len <= BLADE_MAX_2B_STR_LEN)
			ret = 2;
		else if(len <= BLADE_MAX_3B_STR_LEN)
			ret = 3;
		else if(len <= BLADE_MAX_4B_STR_LEN)
			ret = 4;
		else if (len <= BLADE_MAX_5B_STR_LEN)
			ret = 5;
		else
			ret = -1;
	}
...
inline int encode_str(char *buf,const int64_t buf_len,int64_t& pos,const void *vbuf,int64_t len)
{
	...
	{
		int8_t first_byte = BLADE_VARCHAR_TYPE;
		...
		{
			first_byte |= (len_size  - 1 + BLADE_MAX_1B_STR_LEN);
		}
		...
		else if (len_size > 1)
		{
			...
			{
				if (BLADE_SUCCESS != (ret = encode_i8(buf,buf_len,pos,len >> (n << 3))))
				{
					break;
				}
			}
		...
		if (BLADE_SUCCESS == ret && (NULL != vbuf) & (len > 0))
		{
			memcpy(buf + pos,vbuf,len);
			pos += len;
		}
...
inline const char *decode_str(const char *buf,const int64_t data_len,int8_t first_byte,int64_t& pos,int32_t& lenp)
{
	...
	{
		int8_t len_or_value = first_byte & BLADE_VARCHAR_LEN_MASK;
		int64_t str_len = 0;
		if (len_or_value <= BLADE_MAX_1B_STR_LEN)
		{ 
		...
		{
			int8_t tmp = 0;
			for(int n=0;n<len_or_value - BLADE_MAX_1B_STR_LEN;++n)
			{
				if (BLADE_SUCCESS != (ret = decode_i8(buf,data_len,pos,&tmp)))
				{
					str_len = -1;
					break;
				}
		...
		if ((BLADE_SUCCESS == ret) && (str_len >= 0) && (data_len - pos >= str_len))
		{
			str = buf + pos;
			pos += str_len;
			lenp = str_len;
...
inline int encode_float_type(char *buf,const int64_t buf_len,int64_t& pos,const float val,const bool is_add)
{
	...
	memcpy(&tmp,&val,sizeof(tmp));
	int ret = BLADE_ERROR;
	int8_t first_byte = BLADE_FLOAT_TYPE;

	if (is_add)
	{
		set_bit(first_byte,BLADE_FLOAT_OPERATION_BIT_POS);
	}
...
inline int decode_float_type(const char *buf,const int64_t data_len,int8_t first_byte,int64_t& pos,float& val,bool& is_add)
{
	...
	{
		int32_t tmp = 0;
		if ( BLADE_SUCCESS != (ret = decode_i32(buf,data_len,pos,&tmp)))
		{
			ret = BLADE_ERROR;
		}
		else
		...
		if (BLADE_SUCCESS == ret)
		{
			is_add = test_bit(first_byte,BLADE_FLOAT_OPERATION_BIT_POS);
		}
	}
	return ret;
}
...
inline int encode_double_type(char *buf,const int64_t buf_len,int64_t& pos,double val,const bool is_add)
{
	...
	int8_t first_byte = BLADE_DOUBLE_TYPE;
...
inline int decode_double_type(const char *buf,const int64_t data_len,int8_t first_byte,int64_t& pos,double& val,bool& is_add)
{
	...
	{
		int64_t tmp = 0;
		if ( BLADE_SUCCESS != (ret = decode_i64(buf,data_len,pos,&tmp)))
		{
			ret = BLADE_ERROR;
		}
		else
